...
export const FALLBACK_TOP_ASSETS: CryptoAsset[] = [
  ...
  { id: "usd-coin", symbol: "USDC", name: "USD Coin", marketCapRank: 6 },
  { id: "ripple", symbol: "XRP", name: "XRP", marketCapRank: 7 },
  { id: "staked-ether", symbol: "STETH", name: "Lido Staked Ether", marketCapRank: 8 },
  { id: "dogecoin", symbol: "DOGE", name: "Dogecoin", marketCapRank: 9 },
  { id: "cardano", symbol: "ADA", name: "Cardano", marketCapRank: 10 },
  { id: "tron", symbol: "TRX", name: "TRON", marketCapRank: 11 },
  { id: "avalanche-2", symbol: "AVAX", name: "Avalanche", marketCapRank: 12 },
  { id: "shiba-inu", symbol: "SHIB", name: "Shiba Inu", marketCapRank: 13 },
  { id: "chainlink", symbol: "LINK", name: "Chainlink", marketCapRank: 14 },
  { id: "wrapped-bitcoin", symbol: "WBTC", name: "Wrapped Bitcoin", marketCapRank: 15 },
  { id: "polkadot", symbol: "DOT", name: "Polkadot", marketCapRank: 16 },
  { id: "bitcoin-cash", symbol: "BCH", name: "Bitcoin Cash", marketCapRank: 17 },
  { id: "matic-network", symbol: "MATIC", name: "Polygon", marketCapRank: 18 },
  { id: "litecoin", symbol: "LTC", name: "Litecoin", marketCapRank: 19 },
